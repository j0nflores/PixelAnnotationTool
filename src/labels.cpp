...
Name2Labels defaultLabels() {
	...
	labels["background"           ] = LabelInfo("background"           , "void"         ,  00, 0, QColor(  0,  0,  0));
	labels["mud"         ] = LabelInfo("mud"         , "void"         ,  01, 0, QColor(  180,  150,  100));
	labels["clear"] = LabelInfo("clear", "void"         ,  02, 0, QColor(  0,  0,  255));
